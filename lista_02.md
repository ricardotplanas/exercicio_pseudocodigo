...
C) A saída de calcularOrcamento() seria: 'Seu saldo é negativo de -100.' e a de calcularOrcamento2() seria: 'Seu saldo é negativo de -1050.' Alternativa correta
...
class Circulo extends FormaGeometrical
    Construtor (cor, raio){
        super(cor)
        this.raio = raio;
    }
...
let retangulo = new Retangulo('"vermelho", 43, 62||
...
Função simularCorrida(distancia, velocidadeInicial, aceleracao, velocidadeMaxima, tempoMaximo)
    ...
    While true:
        ...
        If velocidade > velocidadeMaxima:
            return ("O carro excedeu a velocidade máxima permitida.")
        If tempo > tempoMaximo:
            return ("A corrida demorou mais do que o tempo máximo permitido.")
        If (distancia / velocidade) <= tempo:
            return ("tempo")
______
